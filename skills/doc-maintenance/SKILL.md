...
metadata:
  paperclip:
    catalog:
      skillKey: paperclipai/bundled/docs/doc-maintenance
      catalogId: "paperclipai:bundled:docs:doc-maintenance"
      catalogKey: paperclipai/bundled/docs/doc-maintenance
      catalogKind: bundled
      catalogCategory: docs
      catalogPath: catalog/bundled/docs/doc-maintenance
      packageName: "@paperclipai/skills-catalog"
      packageVersion: 0.3.1
      originVersion: 0.3.1
      originHash: "sha256:2e02299210fd17c1fe1867b4ee8c144a11b6fe1fe481f83b8268cfbaaf10f9aa"
      sourceRef: "sha256:2e02299210fd17c1fe1867b4ee8c144a11b6fe1fe481f83b8268cfbaaf10f9aa"
---

## Micronaut Agent Company usage notes

Use this catalog skill for documentation drift created by recent behavior, configuration, API, release-line, or tooling changes. It complements the Micronaut `docs` and `guides` skills; it does not replace their Asciidoctor, `toc.yml`, guide publishing, PDF, and snippet-validation rules.

For this company:

- Prefer minimum-churn documentation updates anchored to user-visible behavior changes. Do not perform style-only rewrites or broad reorganizations during routine maintenance.
- Technical Writer owns proactive user-guide and guide-topic routines, but Micronaut Engineer and Code Reviewer should use this skill when implementation or review discovers stale docs.
- Docs branches must still be updated from the approved target branch before PR publication or update.
- Use `[skip ci]` only when the changed docs are not build-validated; executable snippets, generated guides, `./gradlew publishGuide`, and build-checked docs still require validation.
