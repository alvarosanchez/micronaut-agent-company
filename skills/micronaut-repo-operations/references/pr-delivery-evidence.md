...
- The implementation owner creates or updates the GitHub PR after local validation and before QA verification. `code-reviewer` is a pure final gate and must not create, update, or publish it.
...
- A repository-changing implementation branch with no acceptable linked PR is unfinished delivery work. The owner records a publication blocker rather than routing unpublished changes into QA or review.
