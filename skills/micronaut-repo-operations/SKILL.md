...
- Use linked Paperclip approvals for human governance decisions such as inadequate contributor PR closures and package-policy exceptions. Do not treat a free-form comment as approval.
...
- QA does not publish inadequate contributor PR closures or other policy-exception proposals on GitHub until the linked approval exists.
