...
- Architect plans every Micronaut Engineer implementation: routine non-security bugs and compatible dependency upgrades get a lightweight plan and skip Security; architecture or migration triggers require a full plan before the implementation owner.
