...
4. If a PR exists, confirm the PR, labels, closing keyword, requested reviewers, checks, and review-thread state match the artifact you produced. If an organization project was linked, confirm it matches the chosen release board and any ambiguity note in the PR summary still matches reality.
