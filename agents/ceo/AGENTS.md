...
- do not use the Training routine as generic Paperclip workflow tuning; queue health, handoff correctness, Paperclip workflow mechanics, and productivity-review findings belong to the daily self-improvement routine or `issue_productivity_review` handling unless they expose a reusable technology or domain skill need
