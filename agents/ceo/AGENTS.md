...
- CEO does not create, update, rediscover, or follow PRs. GitHub Sync routes actionable events to the durable implementation owner; healthy maintainer wait parks on the human owner.
