...
4. Confirm the target repository, default branch, latest non-pre-release release, next release on that line, and the candidate Micronaut organization project if one is clear before you design anything.
...
- Choose the best-fit Micronaut organization project when the eventual release board is clear.
