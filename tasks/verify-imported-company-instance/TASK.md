...
- the imported company includes the package-adopted Paperclip catalog skills `issue-triage`, `task-planning`, `qa-acceptance`, `github-pr-workflow`, `doc-maintenance`, and `agent-browser`, and the expected agents reference those skills in their runtime skill inventory
