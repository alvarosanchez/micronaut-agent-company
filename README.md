...
| Skill | Purpose |
| --- | --- |
| `paperclip-control-plane` | Deterministic normalized Paperclip issue/document reads, approval-link checks, revision-safe document writes, guarded stage transitions, and read-back verification; grants no delivery authority |
