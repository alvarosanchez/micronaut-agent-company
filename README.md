...
When that routine finds missing or outdated `AGENTS.md` guidance in a managed Micronaut repository, the CEO should update the managed Micronaut repository `AGENTS.md` through a branch and PR in that repository. If repository access or required approval is missing, the report should name the linked approval request or blocker that prevents the PR path.
