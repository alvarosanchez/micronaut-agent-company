...
All agents are configured to use `codex_local` with live web search enabled. Agents with `high` or `xhigh` reasoning use `gpt-5.5-pro`; agents with `medium` reasoning use `gpt-5.5`.
