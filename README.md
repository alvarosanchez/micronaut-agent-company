...
| `paperclipai/bundled/software-development/github-pr-workflow` | CEO, Code Reviewer, Micronaut Engineer, Technical Writer | Branch hygiene, implementation-owner PR publication/follow-through, and read-only final-review readiness while preserving the pure Code Reviewer gate |
